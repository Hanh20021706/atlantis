...

                                    {
                                        products.map((product, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 text-center"> {product.price} </div>
                                                </td>
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 text-center"> {product.desc} </div>
                                                </td>
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 text-center" style={{ display: 'flex', justifyContent: 'center' }}>
                                                        ...
                                                        {product.img ?
                                                            ...
                                                            <img src={product.img} alt="" width={100} /> : null}
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="text-sm text-gray-900 text-center">
                                                        <button onClick={() => { if (window.confirm("delete the item")) { ondelete(product._id as number) } }}>

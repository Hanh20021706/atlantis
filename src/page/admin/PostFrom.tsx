...
const PostFrom = () => {
    ...
    const onSubmit: SubmitHandler<POST_TYPE> = (data) => {
        ...
        return handleSubmitPost(submitData);
    }
    ...
    // tim den product 
    const handleGetPost = async (_id: string) => {
        const response = await getPost(_id);
        if (response.status === 200) {
            reset({
                ...response.data,
                        ...
                        <div className="shadow sm:rounded-md sm:overflow-hidden">
                            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div className="">
                                    ...
                                    <label htmlFor="company-website" className="block text-sm font-medium text-gray-700"> author </label>
                                    <div className="mt-1 flex rounded-md shadow-sm">
                                        <input type="text"
                                            {
                                            ...register('author', {
